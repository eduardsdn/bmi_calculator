...
{/* <div className={AppCSS.limitationsCards}>
                ...
                <LimitationsCard limitationsCardIcon={limitationsRaceImg} id={AppCSS.hey}limitationsCardTitle={"Race"} limitationsCardText={"Certain health concerns may affect individuals of some Black and Asian origins at lower BMIs than others. To learn more, it is advised to discuss this with your GP or practice nurse."}/>
              </div> */}