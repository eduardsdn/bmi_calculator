          ...
          <div className={AppCSS.limitations}>
            <div className={AppCSS.rowOne}>
              <div className={AppCSS.limitationsTextContent}>
                ...
                <p className={AppCSS.limitationsText}>
              ...
              <LimitationsCard
                limitationsCardIcon={limitationCards[0].img}
                limitationsCardTitle={limitationCards[0].title}
                limitationsCardText={limitationCards[0].text}
              />
            </div>
            <div className={AppCSS.rowTwo}>
              <LimitationsCard
                limitationsCardIcon={limitationCards[1].img}
                limitationsCardTitle={limitationCards[1].title}
                limitationsCardText={limitationCards[1].text}
              />
              <LimitationsCard
                limitationsCardIcon={limitationCards[2].img}
                limitationsCardTitle={limitationCards[2].title}
                limitationsCardText={limitationCards[2].text}
              />
            </div>
            <div className={AppCSS.rowThree}>
              <LimitationsCard
                limitationsCardIcon={limitationCards[3].img}
                limitationsCardTitle={limitationCards[3].title}
                limitationsCardText={limitationCards[3].text}
              />
              <LimitationsCard
                limitationsCardIcon={limitationCards[4].img}
                limitationsCardTitle={limitationCards[4].title}
                limitationsCardText={limitationCards[4].text}
              />
            </div>
          </div>
        ) : (
          <div className={AppCSS.limitations}>
            ...
            <div className={AppCSS.limitationsCards}>
              {[
                ...
                return (
                  <LimitationsCard
                    limitationsCardIcon={limitationCard.img}
                    limitationsCardTitle={limitationCard.title}
                    limitationsCardText={limitationCard.text}
                  />
                );
              })}
            </div>
