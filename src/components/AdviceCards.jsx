    ...
    return (
        <div className={AdviceCardsCSS.adviceCards}>
            <div className={AdviceCardsCSS.adviceCard}>
                ...
                <p className={AdviceCardsCSS.text}>Healthy eating promotes weight control, disease prevention, better digestion, immunity, mental clarity, and mood.</p>
            </div>
            <div className={AdviceCardsCSS.adviceCard}>
                <img src={exerciseImg} className={AdviceCardsCSS.adviceCardImg} alt="" />
                <h1 className={AdviceCardsCSS.title}>Regular exercise</h1>
                <p className={AdviceCardsCSS.text}>Exercise improves fitness, aids weight control, elevates mood, and reduces disease risk, fostering wellness and longevity.</p>
            </div>
            <div className={AdviceCardsCSS.adviceCard}>
                <img src={sleepImg} className={AdviceCardsCSS.adviceCardImg} alt="" />
                <h1 className={AdviceCardsCSS.title}>Adequate sleep</h1>
                <p className={AdviceCardsCSS.text}>Sleep enhances mental clarity, emotional stability, and physical wellness, promoting overall restoration and rejuvenation.</p>
            </div>
        </div>
    )
}
